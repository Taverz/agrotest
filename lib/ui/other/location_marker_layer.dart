...
import 'circle_marker_custom.dart' as circecustom;
import 'data.dart';
import './heading_sector.dart';
...
class LocationMarkerLayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 20, //heading!.heading,
    // 280, //heading!.accuracy,
    // 2.427256879118272 :: 0.3141592653589793
    // if(heading!=null)
    // print('HEADING WWW ${heading!.heading} :: ${heading!.accuracy}');
    return Stack(
      children: [
        if (style.showAccuracyCircle)
          circecustom.CircleLayer(
            circles: [
              // CircleMarker(
